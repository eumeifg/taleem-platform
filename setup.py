...
setup(
    ...
    entry_points={
        "openedx.course_tab": [
            ...
            "exams = lms.djangoapps.courseware.tabs:ExamsTab",
        ],
        "openedx.course_tool": [
            ...
            "course_notifications = openedx.custom.notifications.plugins:CourseNotificationsTool",
        ...
        "openedx.block_structure_transformer": [
            ...
            "freechapters = lms.djangoapps.course_api.blocks.transformers.free_chapters:FreeChapterTransformer",
        ],
        "openedx.ace.policy": [
        ...
        "lms.djangoapp": [
            ...
            "notifications = openedx.custom.notifications.apps:NotificationsConfig",
