...
from openedx.custom.question_bank.views import can_delete_xblock, get_question_bank_statistic_with_tags
from openedx.custom.timed_exam.views import timed_exam_handler
from openedx.custom.taleem_search.views import course_filters_view
from openedx.custom.payment_gateway.views import course_price_view
from openedx.custom.taleem.views import bulk_registration, archive_course
...
urlpatterns = [
    ...
    url(r'^enrollments/{}?$'.format(settings.COURSE_KEY_PATTERN),
        contentstore.views.enrollments_handler,
        name='enrollments_handler'),
    ...
    url(r'^import/csv/{}$'.format(COURSELIKE_KEY_PATTERN), contentstore.views.import_csv_handler,
        name='import_csv_handler'),
    url(r'^import_status/csv/{}/(?P<filename>.+)$'.format(COURSELIKE_KEY_PATTERN),
        contentstore.views.import_csv_status_handler, name='import_csv_status_handler'),
    ...
    url(r'^export/csv/{}$'.format(COURSELIKE_KEY_PATTERN), contentstore.views.export_csv_handler,
        name='export_csv_handler'),
    url(r'^export_status/csv/{}$'.format(COURSELIKE_KEY_PATTERN), contentstore.views.export_csv_status_handler,
        name='export_csv_status_handler'),
    ...
    url(r'^settings/advanced/{}$'.format(COURSELIKE_KEY_PATTERN), contentstore.views.advanced_library_settings_handler,
        name='advanced_library_settings_handler'),
    url(r'^settings/filters/{}$'.format(COURSELIKE_KEY_PATTERN), course_filters_view, name='course_filter_settings'),
    url(r'^settings/price/{}$'.format(COURSELIKE_KEY_PATTERN), course_price_view, name='course_price_settings'),
    ...
    url(r'^video_transcoding/status/$',
        contentstore.views.video_transcoding_handler, name='video_transcoding_handler'),
    ...
    url(r'^bulk-registration', bulk_registration, name='taleem_bulk_registration'),
    url(r'^{}/archive-course/'.format(settings.COURSE_KEY_PATTERN), archive_course, name='archive_course'),
    url(r'^api/taleem-interactivexblock/', include('openedx.custom.taleem_interactivexblock_utils.api.urls')),
]
...
urlpatterns += [
    url(r'^timed-exam/{}/'.format(COURSELIKE_KEY_PATTERN), include('openedx.custom.timed_exam.urls_studio')),
    url(r'^timed-exams/{}?$'.format(COURSELIKE_KEY_PATTERN), timed_exam_handler, name='timed_exam_handler'),
    url(r'^question-bank/{}/'.format(COURSELIKE_KEY_PATTERN), include('openedx.custom.question_bank.urls')),
    url(r'^question-bank/statistics-with-tags/', get_question_bank_statistic_with_tags,
        name='question_bank_statistic_with_tags'),
    ...
    url(r'^videos/front/', include('openedx.custom.videos.urls')),
    # Enrollment API RESTful endpoints
    url(r'^api/enrollment/v1/', include('openedx.core.djangoapps.enrollments.urls')),
    url(r'^can_delete_xblock/{}/'.format(settings.USAGE_KEY_PATTERN), can_delete_xblock, name='can_delete_xblock'),
