        ...
        ActiveVideoUploadListView = BaseView.extend({
            ...
            render: function() {
                ...
                this.$uploadForm.fileupload({
                    ...
                    chunkdone: this.fileUploadChunkDone.bind(this),
                            ...
                            $.ajax({
                                ...
                                data: JSON.stringify({
                                    files: [{
                                        ...
                                        parts: Math.ceil(file.size/20000000)
                                    }]
                                }),
                                dataType: 'json',
                                type: 'POST',
                                ...
                                _.each(
                                    ...
                                    function(file) { // eslint-disable-line no-shadow
                                        view.$uploadForm.fileupload('add', {
                                            ...
                                            url: file.upload_urls[0],
                                            urls: file.upload_urls,
                                            uploadId: file.upload_id,
                                            totalParts: file.parts,
                                            finalParts: [],
                                            videoId: file.edx_video_id,
                                            multipart: false,
                                            maxChunkSize: 20 * 1000000, // 20MB
                                            global: false,  // Do not trigger global AJAX error handler
                                            redirected: true
                                        });
                                    }
            ...
            fileUploadChunkDone: function(event, data) {
                data.finalParts.push({
                    "PartNumber": parseInt(this.getParameterByName("partNumber", data.url)),
                    "ETag": JSON.parse(data.jqXHR.getResponseHeader("etag").replace("W/", ""))
                });
            },
