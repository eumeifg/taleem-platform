    ...
    function($, _, gettext, BaseView, XBlockView, MetadataView, MetadataCollection) {
        var XBlockEditorView = XBlockView.extend({
            ...
            initializeEditors: function() {
                ...
                // If the current_editor is QuizMaker then we need to initialize it.
                if (this.xblock.current_editor instanceof TaleemEditor.QuizMaker) {
                    this.quizmakerEditor = this.xblock.current_editor;
                    this.selectMode(defaultMode);
                }
            },
            ...
            hasQuizMakerRendered: function() {
                return this.$('.quiz-maker-editor').length > 0;
            },
            ...
            getQuizMakerEditor: function() {
                return this.quizmakerEditor;
            },
            ...
            getXBlockFieldData: function() {
                var xblock = this.xblock,
                    ...
                    quizmakerEditor = this.getQuizMakerEditor(),
                    data = null;
                ...
                // ... else if this is an XModule then call its save method
                    ...
                    data = xblock.save();
                    if (quizmakerEditor || metadataEditor) {
