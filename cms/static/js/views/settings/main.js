define(['js/views/validation', 'codemirror', 'underscore', 'jquery', 'jquery.ui', 'js/utils/date_utils',
    ...
    // Model class is CMS.Models.Settings.CourseDetails
        ...
        // Clear any image preview timeouts set in this.updateImagePreview
                   ...
                   var publicButton = this.$('#course-visibility-public'),
                       privateButton = this.$('#course-visibility-private');
                   (this.model.get('visibility') ? privateButton : publicButton).attr('checked', true);
        ...
        // Wait for a second to load the video, avoiding egregious AJAX calls.
            ...
            // Fallthrough to handle both radio buttons
                   case 'course-pace-instructor-paced':
                       ...
                       break;
                   case 'course-visibility-public':
            // Fallthrough to handle both radio buttons
                   case 'course-visibility-private':
                       this.model.set('visibility', JSON.parse(event.currentTarget.value));
                       break;
