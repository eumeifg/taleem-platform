        ...
        Import: function(feedbackUrl, library) {
            var dbError,
                ...
                showImportSubmit = function() {
                    ...
                    if (filepath.substr(filepath.length - 6, 6) === 'tar.gz' || filepath.substr(filepath.length - 4, 4) === '.csv') {
                        $('.error-block').hide();
            ...
            $('#fileupload').fileupload({
                dataType: 'json',
                type: 'POST',
                maxChunkSize: 500 * 1000000, // 500 MB
                autoUpload: false,
                add: function(e, data) {
                    Import.reset();
                    ...
                    if (file.name.match(/tar\.gz$/) || file.name.match(/\.csv$/)) {
