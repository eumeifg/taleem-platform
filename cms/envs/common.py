...
PIPELINE['STYLESHEETS'] = {
    'style-vendor': {
        'source_filenames': [
            ...
            'css/vendor/jquery.modal.min.css',
...
OPTIONAL_APPS = (
    ...
    # Required by the payment_gateway app
...
######################### Taleem Platform Settings #########################
HIDDEN_ADVANCED_SETTINGS = [
    'allow_anonymous',
...
AWS_S3_ENDPOINT_URL = "https://storage-ta3leem.dev.env.creativeadvtech.com"
