...
cp /root/config/mc/config.json /root/.mc/config.json || echo "mc configuration not founded!"
cp /root/newrelic/newrelic.ini /openedx/newrelic.ini || echo "newrelic config not found!"
