...
class CourseEnrollmentAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'course', 'user', 'created', 'is_active',)
    list_filter = ('mode', 'is_active', 'created')
...
class UserAdmin(BaseUserAdmin):
    ...
    list_filter = ('is_staff', 'is_superuser', 'is_active', ('date_joined', DateRangeFilter), 'groups')
