...
class ProctoredExamStudentAttemptStatus:
    ...
    # the student needs no verification
    no_verification_need = 'no_verification_need'

    # the student needs to add enrollment code before entrance
    enrollment_code_required = 'enrollment_code_required'
