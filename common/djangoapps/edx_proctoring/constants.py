...
MAX_AWAY_TIME_ALLOWED_MINS = (
    settings.PROCTORING_SETTINGS['MAX_AWAY_TIME_ALLOWED_MINS'] if
    'MAX_AWAY_TIME_ALLOWED_MINS' in settings.PROCTORING_SETTINGS
    else getattr(settings, 'MAX_AWAY_TIME_ALLOWED_MINS', 60)
)
