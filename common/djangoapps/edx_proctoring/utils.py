...
def get_approved_statuses(timed_exam):
    ...
    if verified_state_config.status == photo_verification_status_class.STATUS.approved_by_ai:
        approved_statuses.append('approved_by_ai')
    allow_everyone = verified_state_config.status == photo_verification_status_class.STATUS.allow
    return approved_statuses, allow_everyone
