...
urlpatterns = [
    ...
    url(
        r'edx_proctoring/v1/proctored_exam/tab/switch/history/{}$'.format(settings.COURSE_ID_PATTERN),
        views.TabSwitchHistory.as_view(),
        name='proctored_exam.tab_switch_history'
    ),
    url(
        r'edx_proctoring/v1/proctored_exam/submit/review/{}$'.format(settings.COURSE_ID_PATTERN),
        views.ProctoredExamReviewStatus.as_view(),
        name='proctored_exam.submit_review'
    ),
    url(
