...
class LoncapaProblem(object):
    ...
    def find_correct_answer_text(self, answer_id):
        ...
        for answer in xml_element.xpath('*[@correct="true"]//text()'):
            if not answer.startswith('\n'):
                correct_answers_parsed.append(answer)
        return ', '.join(correct_answers_parsed)
    ...
    def find_answer_text(self, answer_id, current_answer):
        ...
        if isinstance(current_answer, list):
            ...
            choices_map = dict(input_cls.extract_choices(choicegroup, self.capa_system.i18n, text_only=False))
