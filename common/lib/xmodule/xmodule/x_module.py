...
class XModuleFields(object):
    ...
    visual_completion = String(
        help=_(
            "Decide on the way this component should be marked for visual completion tracking. "
            "Select Default if video needs to be played, question needs to be graded and other reading should be viewed. "
            "Select Manual if learner is allowed to mark as complete. "
            "Select Disable if this component should be excluded from completion tracking."
        ),
        display_name=_("Visual Completion"),
        default="default",
        values=[
            {"display_name": _("Default"), "value": "default"},
            {"display_name": _("Manual"), "value": "manual"},
            {"display_name": _("Disable"), "value": "disable"},
        ],
        scope=Scope.settings
    )
    ...
    def editable_metadata_fields(self):
        ...
        for field in fields.values():
            ...
            if field.scope not in (Scope.settings, Scope.content):
                continue
            if field.name in custom_hidden_fields:
                continue
