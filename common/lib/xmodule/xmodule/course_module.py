...
class CourseFields(object):
    ...
    course_visibility = String(
        ...
        default=COURSE_VISIBILITY_PUBLIC,
        scope=Scope.settings,
        values=[
    ...
    is_timed_exam = Boolean(
        display_name=_("Is timed exam?"),
        default=False,
        help=_("Whether the course type is exam"),
        scope=Scope.settings
    )
...
class CourseSummary(object):
    ...
    """
    course_info_fields = ['display_name', 'display_coursenumber', 'display_organization', 'end', 'is_timed_exam']

    def __init__(self, course_locator, display_name=u"Empty", display_coursenumber=None, display_organization=None,
                 end=None, is_timed_exam=False):
        """
        ...
        self.end = end
        self.is_timed_exam = is_timed_exam
