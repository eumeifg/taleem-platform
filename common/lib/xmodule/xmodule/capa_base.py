...
class LEARNINGOUTCOME(object):
    LEARNINGOUTCOME0 = ""
    LEARNINGOUTCOME1 = "learning_outcome_1"
    LEARNINGOUTCOME2 = "learning_outcome_2"
    LEARNINGOUTCOME3 = "learning_outcome_3"
    LEARNINGOUTCOME4 = "learning_outcome_4"
    LEARNINGOUTCOME5 = "learning_outcome_5"
    LEARNINGOUTCOME6 = "learning_outcome_6"
    LEARNINGOUTCOME7 = "learning_outcome_7"
    LEARNINGOUTCOME8 = "learning_outcome_8"
    LEARNINGOUTCOME9 = "learning_outcome_9"
    LEARNINGOUTCOME10 = "learning_outcome_10"
...
class ChapterName(String):
    """
    Define a field to store chapter name after cleaning it.
    """
    def from_json(self, value):
...
class CapaFields(object):
    ...
    showanswer = String(
        ...
        values=[
            ...
            {"display_name": _("After First Attempt"), "value": SHOWANSWER.ATTEMPTED},
            ...
            {"display_name": _("Never Appear"), "value": SHOWANSWER.NEVER},
    ...
    chapter = ChapterName(
        ...
        help=_("The name of the chapter this problem belongs to. There should be an integer in it."),
        scope=Scope.settings,
    )
    topic = String(
        display_name=_("Topics"),
        help=_("The name of the topics this problem belongs to. All the topics should be comma separated. "),
        scope=Scope.settings,
    )

    difficulty_level = String(
        display_name=_("Difficulty Level"),
        help=_("The difficulty level of the question."),
        scope=Scope.settings,
        default=DIFFICULTYLEVEL.EASY,
        values=[
            {"display_name": _("Easy Question"), "value": DIFFICULTYLEVEL.EASY},
            {"display_name": _("Moderate Question"), "value": DIFFICULTYLEVEL.MODERATE},
            {"display_name": _("Hard Question"), "value": DIFFICULTYLEVEL.HARD},
        ]
    )

    learning_output = String(
        display_name=_("Learning Outcome"),
        help=_("The learning outcome covered by the question"),
        scope=Scope.settings,
        default=LEARNINGOUTCOME.LEARNINGOUTCOME0,
        values=[
            {"display_name": _("Not set Yet"), "value": LEARNINGOUTCOME.LEARNINGOUTCOME0},
            {"display_name": _("Learning Outcome 1"), "value": LEARNINGOUTCOME.LEARNINGOUTCOME1},
            {"display_name": _("Learning Outcome 2"), "value": LEARNINGOUTCOME.LEARNINGOUTCOME2},
            {"display_name": _("Learning Outcome 3"), "value": LEARNINGOUTCOME.LEARNINGOUTCOME3},
            {"display_name": _("Learning Outcome 4"), "value": LEARNINGOUTCOME.LEARNINGOUTCOME4},
            {"display_name": _("Learning Outcome 5"), "value": LEARNINGOUTCOME.LEARNINGOUTCOME5},
            {"display_name": _("Learning Outcome 6"), "value": LEARNINGOUTCOME.LEARNINGOUTCOME6},
        ]
    )
...
class CapaMixin(ScorableXBlockMixin, CapaFields):
    ...
    def get_problem_html(self, encapsulate=True, submit_notification=False):
        ...
        context = {
            ...
            'visual_completion': getattr(self, "visual_completion", None),
            'done_state': getattr(self, "done", False),
        }
