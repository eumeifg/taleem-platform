    ...
    define([
        ...
        return function(
            ...
            var $accountSettingsElement, userAccountModel, userPreferencesModel, aboutSectionsData,
                ...
                emailFieldView, secondaryEmailFieldView, socialFields, managementFields, accountDeletionFields, platformData,
            ...
            aboutSectionsData = [
                {
                    ...
                    fields: [
                        ...
                        },
                        {
                            view: new AccountSettingsFieldViews.DropdownFieldView({
                                model: userAccountModel,
                                title: gettext('First Day of Week'),
                                valueAttribute: 'calendar_first_day_of_week',
                                options: fieldsData.first_day_of_week.options,
                                persistChanges: true,
                                helpMessage: gettext('Select the first day of the week that use in the calendar')
                            })
                        },
                        {
                            view: new AccountSettingsFieldViews.DropdownFieldView({
                                ...
                                valueAttribute: 'calendar_date_format',
                                options: fieldsData.date_format.options,
                                persistChanges: true,
                                helpMessage: gettext('Select the date format that uses in the calendar')
                            })
                        },
                        {
                            view: new AccountSettingsFieldViews.DropdownFieldView({
                                model: userAccountModel,
                                title: gettext('Receive Reminder Notifications'),
                                valueAttribute: 'calendar_receive_reminder_notifications',
                                options: fieldsData.receive_reminder_notifications.options,
                                persistChanges: true,
                                helpMessage: gettext('Opt in/out from reminder notifications and emails')
                            })
                        },
                    ]
                },
            ...
            if (displayAccountType){
              managementFields = {
                title: gettext('Account Type Fields'),
                subtitle: gettext('Manage you account main settings'),  // eslint-disable-line max-len
                fields: [
                  {
                    view: new AccountSettingsFieldViews.TeacherAccountFieldView({
                      title: gettext('Teacher Account'),
                      screenReaderTitle: gettext('Apply For Teacher Account'),
                      emailAttribute: 'email',
                      valueAttribute: 'teacher_account',
                      linkTitle: gettext('Apply for Teacher Account'),
                      linkHref: '/taleem/apply_for_teacher',
                      helpMessage: gettext('Apply for Teacher Account.')  // eslint-disable-line max-len
                    })
                  },
                ]
              };
              aboutSectionsData.push(managementFields);
            }

            // Add the social link fields
            socialFields = {
                title: gettext('Social Media Links'),
                subtitle: gettext('Optionally, link your personal accounts to the social media icons on your Ta3leem profile.'),  // eslint-disable-line max-len
                fields: []
            };
