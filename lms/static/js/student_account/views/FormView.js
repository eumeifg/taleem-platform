(function(define) {
    ...
    define([
    ...
    ], function($, _, Backbone, gettext, EdxUtilsValidate, HtmlUtils, StringUtils, formErrorsTpl) {
        return Backbone.View.extend({
            ...
            */
            ...
            validateConfirmPasswordFieldOnSubmit: function() {
                ...
                if (passwordFieldValue !== '') {
                    if (passwordFieldValue !== confirmPasswordValue) {
                        validation.message = '<li>' + gettext('Password did not match') + '</li>';
            ...
            getFormData: function() {
                ...
                for (i = 0; i < len; i++) {
                    ...
                    if (key === 'email') {
                        ...
                        $el.val(this.phone_number.getNumber());
                    }

                    if (key) {
                        if (key === 'confirm_password') {
                            validation = this.validateConfirmPasswordFieldOnSubmit($el);
                        } else {
            ...
            liveValidate: function($el, url, dataType, data, method, model) {
                $.ajax({
                    ...
                    complete: function(xhr,status) {
                        if (typeof livaValidateCompleted == 'function') {
                            livaValidateCompleted(status);
                        }
                    }
                });
            },
