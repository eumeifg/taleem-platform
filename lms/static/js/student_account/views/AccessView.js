(function(define) {
    ...
    define([
        ...
        'js/student_account/models/SecondPasswordModel',
        'js/student_account/models/RegisterModel',
        'js/student_account/models/AccountRecoveryModel',
        'js/student_account/views/LoginView',
        'js/student_account/views/PasswordResetView',
        'js/student_account/views/SecondPasswordView',
        ...
        function($, utility, _, _s, Backbone, LoginModel, PasswordResetModel, SecondPasswordModel, RegisterModel, AccountRecoveryModel,
                 LoginView, PasswordResetView, SecondPasswordView, RegisterView, InstitutionLoginView, HintedLoginView, HtmlUtils,
            ...
            // The form currently loaded
                 ...
                 */
                    ...
                    this.formDescriptions = {
                        ...
                        second_password: options.second_password_form_desc,
                    ...
                    this.disable2fa = options.disable_2fa || false;
                ...
                // The login view listens for 'sync' events from the reset model
                    ...
                    this.secondPasswordModel = new SecondPasswordModel({}, {
                        method: 'GET',
                        url: '#'
                    });
                ...
                load: {
                    login: function(data) {
                        ...
                        this.subview.login = new LoginView({
                            ...
                            secondPasswordModel: this.secondPasswordModel,
                    ...
                    // Listen for 'password-help' event to toggle sub-views
                      ...
                      // Listen for 'second-password' event to toggle sub-views
                        this.listenTo(this.subview.login, 'second-password', this.secondPassword);
                    ...
                    second_password: function(data) {
                        this.secondPasswordModel.ajaxType = data.method;
                        this.secondPasswordModel.urlRoot = data.submit_url;

                        this.subview.secondPassword = new SecondPasswordView({
                            fields: data.fields,
                            model: this.secondPasswordModel
                        });

                    // Listen for 'password-email-sent' event to toggle sub-views
                        this.listenTo(
                          this.subview.secondPassword, 'second-password-verified', this.secondPasswordVerified
                        );

                    // Focus on the form
                        $('.second-password-form').focus();
                    },
                ...
                secondPasswordVerified: function() {
                    this.subview.login.trigger('auth-complete');
                },
                ...
                secondPassword: function() {
                    if (this.disable2fa) {
                      // If 2FA is disabled then auto verify the second password.
                      this.secondPasswordVerified();
                    } else {
                      this.element.hide($(this.el).find('#login-form'));
                      this.loadForm('second_password');
                      this.element.scrollTop($('#second-password-anchor'));
                    }
                },
