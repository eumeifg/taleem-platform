    ...
    define([
        ...
        return FormView.extend({
            ...
            events: {
                ...
                'click #resend_activation_email': 'reSendActivationEmail'
            },
            formType: 'login',
            requiredStr: '',
            optionalStr: '',
            ...
            reSendActivationEmail: function(event) {
                event.preventDefault();
                ...
                var settings = {
                  ...
                  $.ajax(settings).done(function (response) {
                    ...
                    {   var msg = gettext("We have sent activation email again")
                        $('#activation_email_send_message').text(msg)
            ...
            saveError: function(error) {
                ...
                if (errorCode === 'too-many-attempts' && error.responseJSON) {
                    window.location = error.responseJSON.redirect_url + '?next=' +  encodeURIComponent(window.location.pathname + window.location.search);
                }
