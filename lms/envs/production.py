...
EMAIL_HOST = ENV_TOKENS.get('EMAIL_HOST', EMAIL_HOST)  # django default is localhost
EMAIL_PORT = ENV_TOKENS.get('EMAIL_PORT', EMAIL_PORT)  # django default is 25
EMAIL_USE_TLS = ENV_TOKENS.get('EMAIL_USE_TLS', EMAIL_USE_TLS)  # django default is False
SITE_NAME = ENV_TOKENS['SITE_NAME']
SESSION_COOKIE_DOMAIN = ENV_TOKENS.get('SESSION_COOKIE_DOMAIN')
SESSION_COOKIE_HTTPONLY = ENV_TOKENS.get('SESSION_COOKIE_HTTPONLY', True)
CSRF_COOKIE_HTTPONLY = ENV_TOKENS.get('CSRF_COOKIE_HTTPONLY', True)
...
AWS_DEFAULT_ACL = ENV_TOKENS.get('AWS_DEFAULT_ACL', AWS_DEFAULT_ACL)
...
VIDEO_DOWNLOAD_PIPELINE = ENV_TOKENS.get('VIDEO_DOWNLOAD_PIPELINE', VIDEO_DOWNLOAD_PIPELINE)

######################### TALEEM PROCTORING SETTINGS ##############################
PROCTORING_SNAP_INTERVAL_IN_SECONDS = ENV_TOKENS.get(
    'PROCTORING_SNAP_INTERVAL_IN_SECONDS', PROCTORING_SNAP_INTERVAL_IN_SECONDS
)
PROCTORING_SNAP_WIDTH = ENV_TOKENS.get('PROCTORING_SNAP_WIDTH', PROCTORING_SNAP_WIDTH)
PROCTORING_SNAP_HEIGHT = ENV_TOKENS.get('PROCTORING_SNAP_HEIGHT', PROCTORING_SNAP_HEIGHT)

# Proctoring report related settings
PROCTORING_VIOLATION_PENALTY = ENV_TOKENS.get('PROCTORING_VIOLATION_PENALTY', PROCTORING_VIOLATION_PENALTY)
PROCTORING_VIOLATION_IGNORE_LIMIT = ENV_TOKENS.get('PROCTORING_VIOLATION_IGNORE_LIMIT', PROCTORING_VIOLATION_IGNORE_LIMIT)
PROCTORING_VIOLATION_WARN_LIMIT = ENV_TOKENS.get('PROCTORING_VIOLATION_WARN_LIMIT', PROCTORING_VIOLATION_WARN_LIMIT)

####################### TA3LEEM 2 FACTOR AUTHENTICATION ############################
DISABLE_2FA = ENV_TOKENS.get('DISABLE_2FA', DISABLE_2FA)
ENABLE_2FA_EMAIL = ENV_TOKENS.get('ENABLE_2FA_EMAIL', ENABLE_2FA_EMAIL)
ENABLE_2FA_MESSAGE = ENV_TOKENS.get('ENABLE_2FA_MESSAGE', ENABLE_2FA_MESSAGE)
TWILIO_SID = ENV_TOKENS.get('TWILIO_SID', TWILIO_SID)
TWILIO_AUTH_TOKEN = ENV_TOKENS.get('TWILIO_AUTH_TOKEN', TWILIO_AUTH_TOKEN)
TWILIO_FROM_NUMBER = ENV_TOKENS.get('TWILIO_FROM_NUMBER', TWILIO_FROM_NUMBER)


#################### COUNTRIES ##################################
COUNTRIES_ONLY = ENV_TOKENS.get('COUNTRIES_ONLY', COUNTRIES_ONLY)

################### LIVE CLASS SETTINGS #########################
JITSI_SERVER_URL = ENV_TOKENS.get('JITSI_SERVER_URL', JITSI_SERVER_URL)
JITSI_SERVER_APP_ID = ENV_TOKENS.get('JITSI_SERVER_APP_ID', JITSI_SERVER_APP_ID)
JITSI_SERVER_SECRET = ENV_TOKENS.get('JITSI_SERVER_SECRET', JITSI_SERVER_SECRET)


################## COURSE FILTERATION SETTINGS ###################
COURSE_PER_PAGE = ENV_TOKENS.get('COURSE_PER_PAGE', COURSE_PER_PAGE)


#################### SUPPORT CHAT TAWK WIDGET #####################
TAWK_WIDGET_LINK_AR = ENV_TOKENS.get('TAWK_WIDGET_LINK_AR')
TAWK_WIDGET_LINK_EN = ENV_TOKENS.get('TAWK_WIDGET_LINK_EN')


############### Settings for Django Rate limit #####################
RATELIMIT_ENABLE = ENV_TOKENS.get('RATELIMIT_ENABLE', RATELIMIT_ENABLE)
RATELIMIT_RATE = ENV_TOKENS.get('RATELIMIT_RATE', RATELIMIT_RATE)
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'user': ENV_TOKENS.get('THROTTLE_RATES_USER', '1000/second'),
        'service_user': ENV_TOKENS.get('THROTTLE_RATES_SERVICE_USER', '1000/second'),
        'registration_validation': ENV_TOKENS.get('THROTTLE_RATES_REGISTRATION', '1000/second'),
    },
}

############################## Ta3leem Settings ###############################
API_CACHE_TIMEOUT = ENV_TOKENS.get('API_CACHE_TIMEOUT', API_CACHE_TIMEOUT)
SOCIAL_MEDIA_FOOTER_URLS = ENV_TOKENS.get('SOCIAL_MEDIA_FOOTER_URLS', SOCIAL_MEDIA_FOOTER_URLS)
AI_MODULE_URL = ENV_TOKENS.get('AI_MODULE_URL', AI_MODULE_URL)
ENVIRONMENT = ENV_TOKENS.get('ENVIRONMENT', ENVIRONMENT)
IOS_APP_BUNDLE_ID = ENV_TOKENS.get('IOS_APP_BUNDLE_ID', 'com.creative.ta3leemapp')

############### FCM - PUSH NOTIFICATIONS ###########
FCM_DJANGO_SETTINGS = ENV_TOKENS.get('FCM_DJANGO_SETTINGS', FCM_DJANGO_SETTINGS)
...
############################## xAPI LRS Settings ###############################
XAPI_LRS_ENDPOINT = ENV_TOKENS.get('XAPI_LRS_ENDPOINT', XAPI_LRS_ENDPOINT)
XAPI_LRS_AUTHTOKEN = ENV_TOKENS.get('XAPI_LRS_AUTHTOKEN', XAPI_LRS_AUTHTOKEN)

##################### TA3LEEM CALENDAR SETTINGS ############################
CALENDAR_FIRST_DAY_OF_WEEK = ENV_TOKENS.get('CALENDAR_FIRST_DAY_OF_WEEK', CALENDAR_FIRST_DAY_OF_WEEK)
CALENDAR_DATE_FORMAT = ENV_TOKENS.get('CALENDAR_DATE_FORMAT', CALENDAR_DATE_FORMAT)

# Identifier included in the User Agent from Ta3leem mobile apps.
MOBILE_APP_USER_AGENT_REGEXES = ENV_TOKENS.get(
    'MOBILE_APP_USER_AGENT_REGEXES',
    MOBILE_APP_USER_AGENT_REGEXES
)

MAX_EMAILS_PER_MINUTE = ENV_TOKENS.get(
