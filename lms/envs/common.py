...
PLATFORM_NAME = _('Ta3leem')
PLATFORM_DESCRIPTION = _('Ta3leem')
...
CONTEXT_PROCESSORS = [
    ...
    # Ta3leem Calendar Processor
    'openedx.custom.taleem_calendar.context_processors.calendar_settings_context',
...
MIDDLEWARE = [
    ...
    'openedx.custom.verification.middleware.SiteAccessMiddleware',

    # Handles automatically storing user ids in django-simple-history tables when possible.
    'simple_history.middleware.HistoryRequestMiddleware',

    # To detect user's browser agent and os
    'django_user_agents.middleware.UserAgentMiddleware',

    # TB middleware to restrict access on defined urls
    'openedx.custom.taleem_browser.middleware.SecureBrowserMiddleware',
...
base_vendor_js = [
    ...
    'common/js/vendor/jquery.browser.js',
...
verification_js = [
    'js/sticky_filter.js',
    'js/query-params.js',
    'js/verification/models/verification_model.js',
    'js/verify_student/views/error_view.js',
    'js/verify_student/views/image_input_view.js',
    'js/verify_student/views/webcam_photo_view.js',
    'js/verify_student/views/step_view.js',
    ...
    'js/verify_student/views/enrollment_confirmation_step_view.js',
    'js/verify_student/views/pay_and_verify_view.js',
    'js/verification/pay_and_verify.js',
]
...
PIPELINE['JAVASCRIPT'] = {
    ...
    'verification': {
      'source_filenames': verification_js,
      'output_filename': 'js/verification.js'
    },
    'reverify': {
...
TALEEM_APPS = [
    'openedx.custom.taleem',
    'openedx.custom.timed_notes',
    'openedx.custom.video_feedback',
    'openedx.custom.notifications.apps.NotificationsConfig',
    'openedx.custom.wishlist',
    'openedx.custom.timed_exam.apps.TimedExamConfig',
    'openedx.custom.offline_exam.apps.OfflineExamConfig',
    'openedx.custom.taleem_grades.apps.TaleemGradesConfig',
    'openedx.custom.taleem_insights',
    'openedx.custom.user_reports',
    'openedx.custom.live_class.apps.LiveClassConfig',
    'openedx.custom.taleem_calendar.apps.TaleemCalendarConfig',
    'openedx.custom.verification',
    'openedx.custom.taleem_organization.apps.TaleemOrganizationConfig',
    'openedx.custom.help.apps.HelpAppConfig',
    'openedx.custom.videos.apps.VideosConfig',
    'openedx.custom.enrollment_dashboard',
    'openedx.custom.taleem_browser.apps.TaleemBrowserConfig',
    'openedx.custom.payment_gateway.apps.PaymentGatewayConfig',
    'openedx.custom.pyinapp.apps.PyInAppConfig',
    'openedx.custom.taleem_search.apps.TaleemSearchConfig',
    'openedx.custom.ebooks.apps.EBooksConfig',
    'openedx.custom.results',
    'django_password_validators',
    'django_password_validators.password_history',
    'openedx.custom.interactive_tools.apps.InteractiveToolsConfig',
    'openedx.custom.teacher.apps.TeacherConfig',
    'openedx.custom.taleem_interactivexblock_utils.apps.TaleemInteractivexblockUtilsConfig',
    'openedx.custom.teacher_dashboard.apps.TeacherDashboardConfig',
    'openedx.custom.cache_admin',
    'openedx.custom.taleem_emails.apps.Ta3leemEmailAppConfig',
]
INSTALLED_APPS += COMMUNITY_APPS + TALEEM_APPS
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': (
        'openedx.custom.rest_framework.renderers.JSONRenderer',
    ),
    'UNICODE_JSON': False,
    'PAGE_SIZE': 10,
...
SOCIAL_MEDIA_FOOTER_URLS = {
    "Facebook": "https://www.facebook.com/ta3leem.iq",
    "Instagram": "https://www.instagram.com/ta3leem.iq/?hl=en",
    "Twitter": "https://twitter.com/Ta3leem6",
    "Linkedin": "https://www.linkedin.com/company/ta3leem-iq",
    "Youtube": "https://www.youtube.com/channel/UC7VkEx6JyRPavUb6VSX-2AA/featured"
}
...
IMAGE_VERIFICATION_ROUTING_KEY = 'edx.lms.core.default'
...
OPTIONAL_APPS = [
    ...
    # Required by the Enterprise App and payment_gateway app
...
ACCOUNT_VISIBILITY_CONFIGURATION["bulk_shareable_fields"] = (
    ACCOUNT_VISIBILITY_CONFIGURATION["public_fields"] + [
        ...
        # Not an actual field, but used to blur the image for female users.
        'gender',
    ]
)
...
REGISTRATION_EXTENSION_FORM = 'openedx.custom.taleem.forms.Ta3leemUserProfileForm'

# Identifier included in the User Agent from Ta3leem mobile apps.
MOBILE_APP_USER_AGENT_REGEXES = [
    r'Ta3leem/org.ta3leem.mobile',
    r'Dart/2.17',
]
...
VERIFY_STUDENT["SOFTWARE_SECURE"] = {
    "API_URL": "http://localhost/direct_validate",
    'STORAGE_CLASS': '',
    'STORAGE_KWARGS': {
        'location': 'face/images',
        'AWS_ACCESS_KEY': 'key',
...
##################### TALEEM PROCTORING SETTINGS ############################
PROCTORING_SNAP_INTERVAL_IN_SECONDS = 10
PROCTORING_SNAP_WIDTH = 640
PROCTORING_SNAP_HEIGHT = 480
AI_MODULE_URL = 'http://45.79.126.118:8001/'
# Image verification request retry settings
IMAGE_VERIFICATION_REQUEST_RETRY_DELAY = 60 * 60
# Maximum of 6 retries before giving up.
IMAGE_VERIFICATION_RETRY_MAX_ATTEMPTS = 6
IMAGE_VERIFICATION_TIMEOUT_SECONDS = 1500
# Proctoring report related settings
PROCTORING_VIOLATION_PENALTY = {
    "tab_switch": 25,
    "session_disconnect": 25,
    "face_not_found": 45,
    "multiple_faces": 50,
    "unknown_face": 50,
}
PROCTORING_VIOLATION_IGNORE_LIMIT = 10
PROCTORING_VIOLATION_WARN_LIMIT = 45
WORDS_NOT_ALLOWED_IN_PASSWORD = [
    "stupid",
    "dummy",
    "fuck",
    "asshole",
...
##################### TA3LEEM 2 FACTOR AUTHENTICATION ############################
DISABLE_2FA = False
ENABLE_2FA_EMAIL = True
ENABLE_2FA_MESSAGE = True
TWILIO_SID = 'SET-ME'
TWILIO_AUTH_TOKEN = 'SET-ME'
TWILIO_FROM_NUMBER = 'SET-ME'


##################### TA3LEEM ############################
API_CACHE_TIMEOUT = 3600  # Value is in seconds

#################### COUNTRIES ##################################
COUNTRIES_ONLY = ['IQ']

################### LIVE CLASS SETTINGS #########################
JITSI_SERVER_URL = "https://liveclass-ta3leem.dev.env.creativeadvtech.com"
JITSI_SERVER_APP_ID = "ta3leem_jitsi_server"
JITSI_SERVER_SECRET = "ta3leem_jitsi_server_secret"

################## COURSE FILTERATION SETTINGS #################
COURSE_PER_PAGE = 9
...
PASSWORD_HASHERS = [
    ...
    'openedx.custom.taleem.hashers.SimpleSHA1PasswordHasher',
]

################## XAPI LRS CONFIGURATION #################
XAPI_LRS_ENDPOINT = 'https://lrs.creativeadvtech.ml/data/xAPI/'
XAPI_LRS_AUTHTOKEN = 'NjUwYTAwZTA2ODVhOGUxYmFlNTRjZmMxYTdmZTAwNTBkZGU5NDkwNzoyZmU5NGNjODkwMWE5OWIyZmNjZDc5NzE0YWQ5ZWQ3ZWM5YzhlYjE5'


##################### TA3LEEM CALENDAR SETTINGS ############################
CALENDAR_FIRST_DAY_OF_WEEK = "sat"
CALENDAR_DATE_FORMAT = "long"

FAILED_LOGGING_THROTTLE_LIMIT = 10

################ TIMED EXAM ALARMS FREQUENCY ################
# Alarm frequency in minutes before timed exam ends.
ALARM_FREQUENCY = [5, 10, 15]
MC_CLIENT_CEPH_ALIAS = 'ta3leem-ceph'
ENVIRONMENT = 'prod'
USER_TASKS_ARTIFACT_STORAGE = 'openedx.custom.storage.backend.S3TA3Storage'

############### FCM - PUSH NOTIFICATIONS ###########
FCM_DJANGO_SETTINGS = {}

# TinyMCE Text Editor settings
TINYMCE_JS_URL = '/static/js/vendor/tinymce/js/tinymce/tinymce.full.min.js'
TINYMCE_DEFAULT_CONFIG = {
    'menubar': False,
    'plugins': 'advlist autolink lists hr link image table code textcolor',
