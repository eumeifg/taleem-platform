...
def get_email_params(course, auto_enroll, secure=True, course_key=None, display_name=None):
    ...
    email_params = {
        ...
        'social_media_urls': get_config_value_from_site_or_settings('SOCIAL_MEDIA_FOOTER_URLS', settings.SITE_NAME),
        'mobile_store_urls': get_config_value_from_site_or_settings('MOBILE_STORE_URLS', settings.SITE_NAME),
    }
    return email_params
...
def send_mail_to_student(student, param_dict, language=None):
    ...
    param_dict['course_qr_code'] = upload_course_qr_code(str(param_dict['course'].id))
