...
from openedx.custom.taleem.services import get_course_completion
from openedx.custom.notifications.api.utils import count_unread_notifications
...
class CourseOverviewField(serializers.RelatedField):
    ...
    def to_representation(self, course_overview):
        ...
        progress = get_course_completion(request, course_overview.id, request.user)
        return {
            # identifiers
            'id': course_id,
            ...
            'progress': progress and int(progress * 100.00),
            'notifications': count_unread_notifications(request.user, course_id),
        }
