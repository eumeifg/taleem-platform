...
def get_blocks(
    ...
    if user is not None:
        ...
        transformers += [VisibilityTransformer()]
    ...
    if request.user.is_anonymous or not CourseEnrollment.is_enrolled(request.user, course_id):
        transformers += [FreeChapterTransformer()]
