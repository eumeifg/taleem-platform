...
from .block_points import BlockPointsTransformer
...
class BlocksAPITransformer(BlockStructureTransformer):
    ...
    def collect(cls, block_structure):
        ...
        BlockPointsTransformer.collect(block_structure)
    ...
    def transform(self, usage_info, block_structure):
        ...
        BlockPointsTransformer().transform(usage_info, block_structure)
