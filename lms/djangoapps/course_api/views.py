...
class CourseDetailView(DeveloperErrorViewMixin, RetrieveAPIView):
    ...
    **Response Values**
        ...
        * ratings: Course rating:
            * `"stars"`: Average number of stars
            * `"num_votes"`: Number of users given vote
        * num_enrolled: Number of learners in the course.
        * languages: List of languages
        * subject: Name of the subject
        * grade: Name of the grade for which the course is targeted
        * price: course price if set
            * amount: Price to buy the course, zero means free
            * amount_paid: If user is logged in and has already paid partial amount
            * amount_to_pay: If user is logged in and has already paid partial amount
        * grade: Name of the grade for which the course is targeted
        * created: Date time when the course was created
