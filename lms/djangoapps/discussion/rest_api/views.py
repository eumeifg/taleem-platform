...
from openedx.core.lib.api.parsers import MergePatchParser, MergePatchParserCharset
...
class ThreadViewSet(DeveloperErrorViewMixin, ViewSet):
    ...
    **PATCH Parameters**:
        ...
        * muted (optional): A boolean to mark thread as muted
    ...
    **POST/PATCH response values**:
        ...
        * muted: Boolean indicating whether the user has muted this thread
    ...
    **DELETE response values:
    ...
    def partial_update(self, request, thread_id):
        ...
        the class docstring.
        """
        if request.content_type not in (MergePatchParser.media_type, MergePatchParserCharset.media_type):
