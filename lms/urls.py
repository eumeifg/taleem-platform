...
from openedx.custom.results.views import publish_results
from openedx.features.enterprise_support.api import enterprise_enabled
from openedx.custom.taleem.views import landing_page, arabic_privacy_policy_page, english_privacy_policy_page
from openedx.custom.timed_exam.course_exams_api import views as course_exams_api_views
...
urlpatterns = [
    ...
    url(r'^content/search/', include('search.urls')),
...
urlpatterns += [
    ...
    # Course Exam's API's
    url(
        r'^courses/{}/exams_list$'.format(
            settings.COURSE_ID_PATTERN,
        ),
        course_exams_api_views.CourseExamsApiView.as_view(),
        name='course_exams_list'
    ),

    url(
        r'^courses/exams/{}/questions'.format(
            settings.COURSE_ID_PATTERN,
        ),
        course_exams_api_views.CourseExamsQuestionsApiView.as_view(),
        name='course_exams_questions'
    ),

    url(
        r'^courses/exams/{}/review'.format(
            settings.COURSE_ID_PATTERN,
        ),
        course_exams_api_views.ExamReviewStatusApiView.as_view(),
        name='course_exams_review'
    ),

    url(
        r'^courses/exams/{course_id}/question/{usage_key}/json'.format(
            course_id=settings.COURSE_ID_PATTERN,
            usage_key=settings.USAGE_ID_PATTERN,
        ),
        course_exams_api_views.ExamQuestionJsonView.as_view(),
        name='exam_question_json'
    ),

    url(
        r'^courses/exams/{course_id}/report'.format(
            course_id=settings.COURSE_ID_PATTERN,
        ),
        course_exams_api_views.ExamReviewReportApiView.as_view(),
        name='exam_report'
    ),
    ...
    # exams tab
    url(
        r'^courses/{}/exams'.format(
            settings.COURSE_ID_PATTERN,
        ),
        courseware_views.course_exams,
        name='course_exams',
    ),
...
# Taleem: Community app urls
urlpatterns += [
    url(r'^tinymce/', include('tinymce.urls')),
]

# Taleem Customization
urlpatterns += [
    url(r'^timed/notes/', include('openedx.custom.timed_notes.urls')),
    url(r'^video/feedback/', include('openedx.custom.video_feedback.urls')),
    url(r'^notifications/', include('openedx.custom.notifications.urls')),
    url(r'^api/notifications/', include('openedx.custom.notifications.api.urls')),
    url(r'^api/wishlist/', include('openedx.custom.wishlist.urls')),
    url(r'^exams/', include('openedx.custom.timed_exam.urls')),
    url(r'^offline/exams/', include('openedx.custom.offline_exam.urls')),
    url(r'^insights/', include('openedx.custom.taleem_insights.urls')),
    url(r'^reports/', include('openedx.custom.user_reports.urls')),
    url(r'^live/class/', include('openedx.custom.live_class.urls')),
    url(r'^api/live-courses/', include('openedx.custom.live_class.api.urls')),
    url(r'verification/', include('openedx.custom.verification.urls')),
    url(r'^taleem-organization/', include('openedx.custom.taleem_organization.urls', namespace='taleem_organization')),
    url(r'^help/', include('openedx.custom.help.urls')),
    url(r'enrollment_dashboard/', include('openedx.custom.enrollment_dashboard.urls')),
    url(r'^payment-gateway/', include('openedx.custom.payment_gateway.urls', namespace='payment_gateway')),
    url(r'^taleem/', include('openedx.custom.taleem.urls', namespace='taleem')),
    url(r'^api/taleem/', include('openedx.custom.taleem.api.urls')),
    url(r'^videos/', include('openedx.custom.videos.urls')),
    url(r'^calendar/', include('openedx.custom.taleem_calendar.urls', namespace='taleem_calendar')),
    url(r'^search/', include('openedx.custom.taleem_search.urls')),
    url(r'^api/search/', include('openedx.custom.taleem_search.api.urls')),
    url(r'^api/', include('openedx.custom.taleem_organization.api.urls')),
    url(r'^api/ebooks/', include('openedx.custom.ebooks.urls')),
    url(r'^api/exams/', include('openedx.custom.timed_exam.api.urls')),
    url(r'^api/vouchers/', include('openedx.custom.payment_gateway.api.urls')),
    url(r'^publish/results/$', publish_results, name='publish_results'),
    url(r'^interactive/tools/', include('openedx.custom.interactive_tools.urls')),
    url(r'^api/teacher/', include('openedx.custom.teacher.api.urls')),
    url(r'^api/inapp/', include('openedx.custom.pyinapp.urls')),
    url(r'^apps/', landing_page, name='apps_landing_page'),
    url(r'^privacy/ar/', arabic_privacy_policy_page, name='arabic_privacy_policy'),
    url(r'^privacy/en/', english_privacy_policy_page, name='english_privacy_policy'),
    url(r'^api/teacher-dashboard/', include('openedx.custom.teacher_dashboard.api.urls')),
    url(r'^teacher-dashboard/', include('openedx.custom.teacher_dashboard.urls', namespace='teacher_dashboard_view')),
]
