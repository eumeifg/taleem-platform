...
import reportlab
import openedx.custom.xhtml2pdf.default
import openedx.custom.xhtml2pdf.parser
...
from openedx.custom.xhtml2pdf.util import (copy_attrs, getColor, getCoords, getFile,
                            getFrameDimensions, getSize, pisaFileObject,
                            set_value, set_asian_fonts, arabic_format, frag_text_language_check)

from openedx.custom.xhtml2pdf.w3c import css
from openedx.custom.xhtml2pdf.xhtml2pdf_reportlab import (PmlPageCount, PmlPageTemplate,
...
class pisaContext(object):
    ...
    def __init__(self, path, debug=0, capacity=-1):
        self.fontList = copy.copy(openedx.custom.xhtml2pdf.default.DEFAULT_FONT)
        self.asianFontList = copy.copy(openedx.custom.xhtml2pdf.default.DEFAULT_ASIAN_FONT)
        set_value(self,
    ...
    def warning(self, msg, *args):
        self.warn += 1
        self.log.append((openedx.custom.xhtml2pdf.default.PML_WARNING, self._getLineNumber(), str(
    ...
    def error(self, msg, *args):
        self.err += 1
        self.log.append((openedx.custom.xhtml2pdf.default.PML_ERROR, self._getLineNumber(), str(
            msg), self._getFragment(50)))
        try:
            return self.context(msg % args)
        except:
