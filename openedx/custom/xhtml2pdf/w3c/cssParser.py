...
from openedx.custom.xhtml2pdf.util import getSize
        ...
        while src and not src.startswith('}'):
            if src.startswith('@'):
                ...
                if "-pdf-page-size" in data:
                    self.c.pageSize = openedx.custom.xhtml2pdf.default.PML_PAGESIZES.get(
                ...
                if "size" in data:
                    ...
                    for value in size:
                        ...
                        if isinstance(value, tuple):
                            ...
                            isLandscape = False
                        elif valueStr in openedx.custom.xhtml2pdf.default.PML_PAGESIZES:
                            self.c.pageSize = openedx.custom.xhtml2pdf.default.PML_PAGESIZES[valueStr]
                        else:
