        ...
        function(gettext, $, _, Backbone, HtmlUtils, TabbedView, SectionTwoTab) {
            var LearnerProfileView = Backbone.View.extend({
                ...
                renderFields: function() {
                    ...
                    this.$('.profile-section-one-fields').append(this.options.NewAddressFieldView.render().el);
                    this.$('.profile-section-one-fields').append(this.options.collegenameFieldView.render().el);
