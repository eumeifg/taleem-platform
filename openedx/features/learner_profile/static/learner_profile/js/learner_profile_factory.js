(function(define) {
    ...
    define([
        ...
        return function(options) {
            ...
            collegenameFieldView = new FieldsView.ReadonlyFieldView({
                model: accountSettingsModel,
                title: gettext("College"),
                screenReaderTitle: gettext('College'),
                valueAttribute: 'college',
                helpMessage: ''
            });

            NewAddressFieldView = new FieldsView.TextareaFieldView({
                model: accountSettingsModel,
                title: gettext('Address'),
                screenReaderTitle: gettext('Address'),
                valueAttribute: 'mailing_address',
                helpMessage: 'Address',
                editable: editable,
                showMessages: false,
                placeholderValue: gettext("Address of User"),
                maxCharacters: 300,
                persistChanges:true,
            });


            nameFieldView = new FieldsView.TextareaFieldView({
                model: accountSettingsModel,
            ...
            sectionOneFieldViews = [
                ...
                new FieldsView.DropdownFieldView({
                    ...
                    titleVisible: true,
                    model: accountSettingsModel,
                    screenReaderTitle: gettext('State'),
                    required: true,
                    editable: editable,
                    showMessages: false,
                    placeholderValue: gettext('Add State'),
                ...
                new FieldsView.TextareaFieldView({
                    ...
                    editable: editable,
                    showMessages: false,
                    title: gettext('Student mobile Number'),
                    placeholderValue: gettext('Student mobile Number'),
                    valueAttribute: 'phone_number',
                    helpMessage: '',
                    titleVisible: true,
                    persistChanges: true,
                    screenReaderTitle: 'Contact Number',
                ...
                new FieldsView.TextareaFieldView({
                    ...
                    editable: editable,
                    showMessages: false,
                    title: gettext('Student Parent Mobile number'),
                    placeholderValue: gettext('Student Parent Mobile number'),
                    valueAttribute: 'sponsor_mobile_number',
                    helpMessage: '',
                    titleVisible: true,
                    persistChanges: true,
                    screenReaderTitle: 'Sponsor Mobile Number',
                    options: options.sponsor_mobile_number,
                    required: true
                }),
                new FieldsView.DropdownFieldView({
                    title: gettext('Student Categories'),
                    titleVisible: true,
                    model: accountSettingsModel,
                    screenReaderTitle: gettext('Student Catagories'),
                    required: true,
                    editable: editable,
                    showMessages: false,
                    placeholderValue: gettext('Student Categories'),
                    valueAttribute: 'category_selection',
                    options: options.category_selection,
                    helpMessage: '',
                    persistChanges: true
                }),
                ...
                new FieldsView.DropdownFieldView({
                    ...
                    titleVisible: true,
                    model: accountSettingsModel,
                    screenReaderTitle: gettext('Grade'),
                    required: true,
                    editable: editable,
                    showMessages: false,
                    placeholderValue: gettext('Add Grade'),
                    valueAttribute: 'grade',
                    options: options.grade_options,
                    helpMessage: '',
                    persistChanges: true
                })
            ];
            ...
            learnerProfileView = new LearnerProfileView({
                ...
                collegenameFieldView: collegenameFieldView,
                NewTestFieldView: NewTestFieldView,
                NewAddressFieldView: NewAddressFieldView,
