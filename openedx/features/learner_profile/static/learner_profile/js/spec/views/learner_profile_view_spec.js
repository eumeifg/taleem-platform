    ...
    function(gettext, Backbone, $, _, PagingCollection, AjaxHelpers, TemplateHelpers, Helpers, LearnerProfileHelpers,
        ...
        describe('edx.user.LearnerProfileView', function() {
            var createLearnerProfileView = function(ownProfile, accountPrivacy, profileIsPublic) {
                ...
                var collegenameFieldView = new FieldViews.ReadonlyFieldView({
                    model: accountSettingsModel,
                    valueAttribute: 'college',
                    helpMessage: ''
                });

                var NewAddressFieldView = new FieldViews.TextareaFieldView({
                    model: accountSettingsModel,
                ...
                var nameFieldView = new FieldViews.TextareaFieldView({
                    model: accountSettingsModel,
                    valueAttribute: 'name',
                    helpMessage: '',
                    editable:editable,
                ...
                var sectionOneFieldViews = [
                    ...
                    new FieldViews.TextareaFieldView({
                        title: 'Student Parent Mobile number',
                        model: accountSettingsModel,
                        required: false,
                        editable: editable,
                        showMessages: false,
