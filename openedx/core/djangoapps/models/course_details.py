...
class CourseDetails(object):
    ...
    def populate(cls, course_descriptor):
        ...
        course_details.visibility = course_descriptor.invitation_only
    ...
    def update_from_json(cls, course_key, jsondict, user):  # pylint: disable=too-many-statements
        ...
        if ('visibility' in jsondict
                and jsondict['visibility'] != descriptor.invitation_only):
            descriptor.invitation_only = jsondict['visibility']
            dirty = True
