...
class CourseOverview(TimeStampedModel):
    ...
    is_timed_exam = BooleanField(default=False)
    appstore_id = models.UUIDField(default=uuid_hex, unique=True)
    ...
    def _create_or_update(cls, course):
        ...
        course_overview.is_timed_exam = course.is_timed_exam
    ...
    def start_display(self):
        ...
        elif self.start and self.start != DEFAULT_START_DATE:
            return defaultfilters.date(utc_datetime_to_local_datetime(self.start), "DATE_FORMAT")
        else:
            return None
    ...
    def get_all_courses(cls, orgs=None, filter_=None, exclude_=None):
        ...
        Arguments:
            ...
            exclude_ (dict): Optional parameter that allows custom filtering.
        """
        # Note: If a newly created course is not returned in this QueryList,
        # make sure the "publish" signal was emitted when the course was
        # created. For tests using CourseFactory, use emit_signals=True.
        course_overviews = CourseOverview.objects.exclude(is_timed_exam=True)
    ...
    def __str__(self):
        ...
        return six.text_type(self.display_name)
