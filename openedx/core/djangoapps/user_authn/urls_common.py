...
from .views import auto_auth, login, logout, password_reset, register, secondary_password
...
urlpatterns = [
    ...
    url(r'^api/user/v1/account/registration/$', register.RegistrationView.as_view(),
    ...
    url(
        r'^account/second-password$',
        secondary_password.second_password_request_handler,
        name='second_password_request'
    ),
