...
INVALID_PHONE_NUMBER = _(
    u"Please enter your correct phone number."
)
...
PHONE_NUMBER_BAD_TYPE_MSG = _(u"Please enter your correct phone number.")
...
REQUIRED_FIELD_PHONE_NUMBER_MSG = _(u"Enter your phone number.")
