...
class AccountViewSet(ViewSet):
    ...
    def retrieve(self, request, username):
        """
            ...
            **Response Values for GET requests to /accounts endpoints**
                ...
                * grade: The standard grade level of the user.
                ...
                * calendar_first_day_of_week: First day of week.
                    * "sun": Sunday
                    * "mon": Monday
                    * "tue": Tuesday
                    * "wed": Wednesday
                ...
                * calendar_date_format: Date format for calendar.
                    * "num": MM/DD/YYYY
                    * "short": MMM DD, YYYY
                    * "long": MMMM DD, YYYY

                * calendar_receive_reminder_notifications: Toggle notifications for reminder.
                    * "true": Receive notifications
                    * "false": Stop notifications
    ...
    def partial_update(self, request, username):
        ...
        You should send such requests using Postman or other alternatives.
