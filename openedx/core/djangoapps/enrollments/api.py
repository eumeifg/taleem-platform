...
def add_enrollment(username, course_id, mode=None, is_active=True, enrollment_attributes=None,
    ...
    Arguments:
        ...
        has_api_key_permissions (boolean): Indicates if the request is made from known source.
    ...
    check_access = not has_api_key_permissions
...
def unenroll_user_from_given_course(username, course_key):
    """
    Unenrolls a specified user from the given course enrolled in.
    :param username: The id of the user being unenrolled.
    :param course_key: Course id from which user is being unenrolled.
    :return: The IDs of all of the organizations from which the learner was unenrolled.
    """
    return _data_api().unenroll_user_from_given_course(username, course_key)
